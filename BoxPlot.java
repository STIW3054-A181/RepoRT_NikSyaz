...
class BoxPlot extends ApplicationFrame implements interfaceBoxplot {

    public BoxPlot(final String tittle) {
        super(tittle);
    ...
    public BoxAndWhiskerCategoryDataset createDataset() {
        ...
        defaultboxandwhiskercategorydataset.add(
                Arrays.asList(3.33, 2.514, 2.546, 1.01),
    ...
    public JFreeChart createChart(BoxAndWhiskerCategoryDataset boxandwhiskercategorydataset) {
        ...
        JFreeChart jfreechart = new JFreeChart("Box Plot of Standard Deviation for 4 PDF Files", categoryplot);
